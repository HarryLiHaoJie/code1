<template>
	<div class="div_bjcolor">
		...
		<div class="content5">
			...
			<p class="po-3">本活动最终解释权为新华金典财富管理所有。</p>
		</div>-->
		...
		<div class="content3">
			<img src="../assets/img/yaoqing3.png"/>
			<div class="con-bottom">
				<p>*邀请人奖励关系的有效期为：被邀请好友注册后30天，30天后奖励关系自动解除。</p>
				<ul>
					<li>您所赚奖金=好友投资金额x奖励系数</li>
